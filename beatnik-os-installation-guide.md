...
This guide explains how to flash **Beatnik OS** (Image) using the **Raspberry Pi Imager v2** and the beatnik custom repository json file.
...
_Raspberry Pi Imager 2.x allows you to pre-configure Wi-Fi and SSH. This is essential for a headless setup. _
 ...
 **NOTE: Every BeatnikOS will first start as a SERVER you can degrade it to be a CLIENT in the App. (Check [Beatnik Controller Repo](https://github.com/byrdsandbytes/beatnik-controller))**

## Usage

Open the controller in your browser on your selected domain. Eg. http://beatnik-001.local.

Or download the App from the Stores and connect to your selected domain.
